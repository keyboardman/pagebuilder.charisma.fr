...
final class BuilderApiListArticleItemsPageNormalizer implements NormalizerInterface
{
    public function normalize(mixed $object, ?string $format = null, array $context = []): array
    {
        if (!$object instanceof BuilderApiListArticleItemsPage) {
            throw new \InvalidArgumentException('Expected BuilderApiListArticleItemsPage.');
        }
    ...
    {
        return $data instanceof BuilderApiListArticleItemsPage;
    }

    public function getSupportedTypes(?string $format): array
    {
        return [BuilderApiListArticleItemsPage::class => true];
    }
