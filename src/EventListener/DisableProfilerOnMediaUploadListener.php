...
/**
 * Désactive le Web Profiler pour la route d’upload média.
...
{
    private const UPLOAD_PATH_PREFIX = '/media/api/upload';
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        if (!str_starts_with($request->getPathInfo(), self::UPLOAD_PATH_PREFIX)) {
            return;
        }
