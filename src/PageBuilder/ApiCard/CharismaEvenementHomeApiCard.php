 ...
 */
final class CharismaEvenementHomeApiCard extends AbstractApiCardImage implements ApiCardBehaviorInterface
{
    ...
    public function fetchCollection(array $params): array
    {
        ...
        try {
            $response = $this->httpClient->request('GET', self::BASE_URL . '/api/charisma/banniere/evenements/home', [
                'query' => $query,
                'timeout' => 30,
            ]);
