...
export function CollectionArticleItemPickerModal({
  open,
  onOpenChange,
  onSelect,
}: CollectionArticleItemPickerModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="api-manager-ui flex max-h-[80vh] max-w-2xl flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Choisissez une API collection (mode dynamic) puis un article à ajouter.
          </DialogDescription>
        </DialogHeader>
