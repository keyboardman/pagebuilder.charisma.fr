...
- [x] 5.2 Tester en local : accès à `/filemanager`, bascule default/s3 (MinIO), upload et navigation ; ouvrir le builder, insérer une image via l’iframe, vérifier que l’URL insérée est absolue et que l’image s’affiche en prévisualisation.
