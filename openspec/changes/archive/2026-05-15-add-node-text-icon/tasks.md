...
- [x] 1.6 Ajouter/mettre à jour les tests (unitaires et/ou intégration) couvrant création, rendu et persistance du nœud.

## 2. Validation
- [x] 2.1 Vérifier manuellement dans l'éditeur que le lien texte fonctionne et que l'icône se place avant/après selon le réglage.
- [x] 2.2 Vérifier que les alignements horizontal/vertical et la taille d'icône sont visibles en édition, preview et rendu final.
- [x] 2.3 Vérifier le mode « Icône du thème » (liste + aperçu classe / image) et le mode « Image » avec la médiathèque.
