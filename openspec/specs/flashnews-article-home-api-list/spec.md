# flashnews-article-home-api-list Specification

## Purpose

Exposer une ApiCard backend `flashnews_article_home` pour lister les articles de la page d'accueil Flashnews dans **NodeListApi**, avec mapping riche et dégradation gracieuse en cas d'erreur API distante.
