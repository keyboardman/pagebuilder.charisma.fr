...
- **THEN** le formulaire React (shadcn/ui) affiche les champs titre, slug, sélecteur de thème, metaTitle (section SEO), description et content ; le champ content affiche le builder de page (pas un textarea) ; le slug peut être pré-rempli à partir du titre
