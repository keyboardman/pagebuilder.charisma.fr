...
- **THEN** le formulaire React (shadcn/ui) affiche les champs titre, slug, sélecteur de thème, description et content ; le slug peut être pré-rempli à partir du titre
